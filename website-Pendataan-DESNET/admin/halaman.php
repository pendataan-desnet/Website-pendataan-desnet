    ...
    <tbody>
        ...
        if ($katakunci != '') {
            ...
            for ($x = 0; $x < count($array_katakunci); $x++) {
                $sqlcari[] = "(barang like '%" . $array_katakunci[$x] . "%' or tanggal_masuk like '%" . $array_katakunci[$x] . "%' or tanggal_keluar like '%" . $array_katakunci[$x] . "%' or nama_penerima like '%" . $array_katakunci[$x] . "%' or note like '%" . $array_katakunci[$x] . "%')";
            }
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="halaman.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Are you sure want to delete this data?')">
